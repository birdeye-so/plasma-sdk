...
exports.ProtocolFeeRecipient = void 0;
const web3_js_1 = require("@solana/web3.js"); // eslint-disable-line @typescript-eslint/no-unused-vars
const bn_js_1 = __importDefault(require("bn.js")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh"));
class ProtocolFeeRecipient {
    constructor(fields) {
    ...
    static fromJSON(obj) {
        return new ProtocolFeeRecipient({
            ...
            totalAccumulatedQuoteFees: new bn_js_1.default(obj.totalAccumulatedQuoteFees),
            collectedQuoteFees: new bn_js_1.default(obj.collectedQuoteFees),
        });
    }
    toEncodable() {
...
exports.ProtocolFeeRecipient = ProtocolFeeRecipient;
//# sourceMappingURL=ProtocolFeeRecipient.js.map